...
public class Runner {
    ...
    public Runner(ClientCommandManager commandManager, InputReader scanner, OutputPrinter console, DragonFactory dragonFactory, InteractionManager interactionManager, SessionHandler sessionHandler, AuthFactory authFactory) {
    ...
    private boolean launchCommand(String line) {
        ...
        try {
            ...
            Optional<Request> request = commandManager.apply(commandName, args, sessionHandler.getLogin(), sessionHandler.getPassword(), ()->null);
