...
public class DragonCave implements Serializable {
    ...
    public void setNumberOfTreasures(Integer numberOfTreasures) throws InvalidArgumentException {

        if (numberOfTreasures != null && numberOfTreasures <= 0) {
            throw new InvalidArgumentException("Количество сокровищ должно быть больше 0!");
        }
